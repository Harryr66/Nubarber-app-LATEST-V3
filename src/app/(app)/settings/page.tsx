           ...
           <Card>
            ...
            <CardContent className="space-y-6">
             ...
             <CardFooter className="flex-col items-start gap-4">
                <p className="text-sm text-muted-foreground">Connect your Stripe account to start accepting online payments for bookings. Stripe handles all the security and compliance for you.</p>
